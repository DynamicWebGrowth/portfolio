        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 text-center text-lg-left">
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                    ...
                    <a target="_blank" href="{{ asset('import/assets/resumes/Vishvas_upadhyay__-_SDE.pdf') }}"
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 pb-4 pb-lg-0">
                <img class="img-fluid rounded w-100" src="{{ asset("import/assets/app/$setting->about_photo") }}" alt="">
            </div>
            <div class="col-lg-7">
            ...
            <div class="col-lg-6">
                ...
                <div class="border-left border-primary pt-2 pl-4 ml-2">
                    ...
                    <div class="position-relative mb-4">
                        ...
                        <p class="mb-2"><strong>{{ $education->association }}</strong> | <small>{{ $education->from }} -
            ...
            <div class="col-lg-6">
                ...
                <div class="border-left border-primary pt-2 pl-4 ml-2">
                    ...
                    <div class="position-relative mb-4">
                        ...
                        <p class="mb-2"><strong>{{ $experience->association }}</strong> | <small>{{ $experience->from }}
        ...
        <div class="row">
            <div class="col-12 text-center mb-2">
                <ul class="list-inline mb-4" id="portfolio-flters">
                    ...
                    <li class="btn btn-sm btn-outline-primary m-1" data-filter=".{{$category->name}}">{{ $category->name
                        }}</li>
                    @endforeach
                </ul>
            </div>
        ...
        <div class="row portfolio-container">
            ...
            <div class="col-lg-4 col-md-6 mb-4 portfolio-item {{$portfolio->category->name }}">
                <div class="position-relative overflow-hidden mb-2">
                    <img class="img-fluid rounded w-100" src="{{ asset("import/assets/app/$portfolio->image")}}" alt="portfolio">
                    <div class="portfolio-btn bg-primary d-flex align-items-center justify-content-center">
                        <a href="{{ asset("import/assets/app/images/$portfolio->image")}}" data-lightbox="portfolio">
            ...
            <div class="col-lg-8">
                <div class="owl-carousel testimonial-carousel">
                    ...
                    <div class="text-center">
                        ...
                        <img class="img-fluid rounded-circle mx-auto mb-3" src="{{ asset(" storage/$review->image") }}"
                    ...
                    <form id="contactForm" method="POST" action="{{ route('contact') }}">
                        ...
                        <div class="form-row">
                            <div class="control-group col-sm-6">
                                <input type="text" class="form-control p-4" id="name" placeholder="Your Name" required
